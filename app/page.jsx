    ...
    <section className="relative flex flex-col items-center text-center px-4 sm:px-8 pt-20 sm:pt-32 pb-16 sm:pb-24">
      <div className="relative z-10 flex flex-col items-center pointer-events-none">
        ...
        <div className="items-center flex flex-col sm:flex-row gap-3 sm:gap-4 pt-8 sm:pt-10 pb-12 sm:pb-16 w-full sm:w-auto px-4 sm:px-0">
          ...
          <a className="pointer-events-auto w-full sm:w-auto text-center border-line border-2 text-white font-bold px-5 py-3 rounded-lg hover:bg-accent active:bg-accent active:scale-95 hover:shadow-[0_0_30px_rgba(177,108,255,0.5)] transition-all duration-150" href="/DinDjarin">View live example</a>
        </div>
      </div>
