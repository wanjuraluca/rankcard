...
const steps = [
  { number: "01", icon: Link2, title: "Connect your accounts", body: "Link League, Valorant and CS2 in seconds." },
...
const faqs = [
  ...
  { q: "Which games are supported?", a: "League of Legends, TFT, Valorant and CS2 today, with more competitive games planned." },
]
