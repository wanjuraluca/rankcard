  ...
  return <main className="bg-background min-h-screen relative">
    ...
    <section className="relative min-h-screen overflow-hidden flex flex-col items-center text-center px-8 pt-32">
      ...
      <div className="relative z-10 flex flex-col items-center pointer-events-none">
        ...
        <div className="items-center flex gap-4 pt-10 pb-16">
      ...
      {/* Feature Cards */}
      <div className="relative z-10 grid grid-cols-3 gap-4 w-full pointer-events-none">
        <div className="bg-surface border border-line rounded-xl p-10 text-left min-h-48">
          <div className="w-12 h-12 rounded-lg bg-accent/10 border border-line mb-6" />
          <p className="text-text-primary font-semibold text-2xl mb-3">Connect your accounts</p>
          <p className="text-text-secondary text-base leading-relaxed">Link League, Valorant and CS2 in seconds.</p>
        </div>
        <div className="bg-surface border border-line rounded-xl p-10 text-left min-h-48">
          <div className="w-12 h-12 rounded-lg bg-accent/10 border border-line mb-6" />
          <p className="text-text-primary font-semibold text-2xl mb-3">See your true rank</p>
          <p className="text-text-secondary text-base leading-relaxed">One overall score across every game you play.</p>
        </div>
        <div className="bg-surface border border-line rounded-xl p-10 text-left min-h-48">
          <div className="w-12 h-12 rounded-lg bg-accent/10 border border-line mb-6" />
          <p className="text-text-primary font-semibold text-2xl mb-3">Share one link</p>
          <p className="text-text-secondary text-base leading-relaxed">A public profile you can drop anywhere.</p>
        </div>
      </div>
    </section>
