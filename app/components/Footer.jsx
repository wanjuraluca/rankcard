export default function Footer() {
    return (
        <footer className="relative z-10 mt-auto flex w-full flex-wrap items-center justify-center gap-4 border-t border-line px-8 py-6 text-xs text-text-secondary">
