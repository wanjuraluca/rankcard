...
export default function ThemeModal({ currentTheme, onClose, onSaved }) {
    ...
    return (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4" onClick={onClose}>
            <div className="bg-surface border border-hairline rounded-2xl w-full max-w-sm overflow-hidden" onClick={e => e.stopPropagation()}>
                ...
                <div className="p-4 grid grid-cols-2 gap-3">
                    {PRESETS.map(theme => {
                        ...
                        return (
                            <button
                                ...
                                className="rounded-lg border p-4 text-left transition-all active:scale-95"
                                style={{
                            ...
                            >
                                <div className="flex items-center gap-2 mb-3">
                                    <div className="w-7 h-7 rounded-lg flex items-center justify-center text-[11px] font-bold text-black" style={{ backgroundColor: theme.accent }}>Y</div>
                    ...
                    >
                        <div className="flex items-center gap-2 mb-3">
                            <div className="w-7 h-7 rounded-lg flex items-center justify-center text-[11px] font-bold text-black" style={{ backgroundColor: resolvedAccent }}>Y</div>
                ...
                {selected === "custom" && (
                    <div className="px-4 pb-4 flex items-center gap-3">
                        <input
                            ...
                            className="w-10 h-10 rounded-lg cursor-pointer border border-hairline bg-transparent"
                        />
                        <div>
                ...
                <div className="flex gap-2.5 p-4 pt-0">
                    ...
                    <button
                        onClick={handleSave}
                        disabled={saving}
                        className="flex-1 rounded-lg py-2.5 text-sm font-semibold text-black active:scale-95 transition-all disabled:opacity-50"
